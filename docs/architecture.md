...
キャプション翻訳 (staka/fugumt-en-ja): Florence-2 が生成した英語キャプションを日本語に翻訳します。これにより、日本語に最適化された Sparse Encoder に適切な入力を与えることができます。
...
graph TD
    ...
    F -->|英語キャプション| H1[キャプション翻訳<br/>fugumt-en-ja]
